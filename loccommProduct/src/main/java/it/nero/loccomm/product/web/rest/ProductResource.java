...
import it.nero.loccomm.product.domain.Product;
import it.nero.loccomm.product.repository.ProductRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.product.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "loccommProductProduct";
