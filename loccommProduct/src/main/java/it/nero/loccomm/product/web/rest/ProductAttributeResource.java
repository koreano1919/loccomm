...
/**
 * REST controller for managing {@link it.nero.loccomm.product.domain.ProductAttribute}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProductAttributeResource {
    ...
    private static final String ENTITY_NAME = "loccommProductProductAttribute";
