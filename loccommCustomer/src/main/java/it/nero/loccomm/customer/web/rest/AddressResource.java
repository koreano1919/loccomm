...
import it.nero.loccomm.customer.repository.AddressRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.customer.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "loccommCustomerAddress";
