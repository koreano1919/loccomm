package it.nero.loccomm.customer.web.rest;

import it.nero.loccomm.customer.domain.Customer;
import it.nero.loccomm.customer.repository.CustomerRepository;
import it.nero.loccomm.customer.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link it.nero.loccomm.customer.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "loccommCustomerCustomer";
