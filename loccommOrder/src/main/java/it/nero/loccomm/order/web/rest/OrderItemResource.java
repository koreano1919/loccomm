package it.nero.loccomm.order.web.rest;

import it.nero.loccomm.order.domain.OrderItem;
import it.nero.loccomm.order.repository.OrderItemRepository;
import it.nero.loccomm.order.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link it.nero.loccomm.order.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderItemResource {
    ...
    private static final String ENTITY_NAME = "loccommOrderOrderItem";
