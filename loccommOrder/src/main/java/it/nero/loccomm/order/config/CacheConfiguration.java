package it.nero.loccomm.order.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("loccommOrder");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("loccommOrder");
        ...
        config.getMapConfigs().put("it.nero.loccomm.order.domain.*", initializeDomainMapConfig(jHipsterProperties));
