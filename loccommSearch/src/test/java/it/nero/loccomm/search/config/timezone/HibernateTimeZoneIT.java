package it.nero.loccomm.search.config.timezone;

import it.nero.loccomm.search.LoccommSearchApp;
import it.nero.loccomm.search.repository.timezone.DateTimeWrapper;
import it.nero.loccomm.search.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = LoccommSearchApp.class)
