package it.nero.loccomm.search.web.rest;

import it.nero.loccomm.search.domain.Category;
import it.nero.loccomm.search.repository.CategoryRepository;
import it.nero.loccomm.search.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link it.nero.loccomm.search.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "loccommSearchCategory";
