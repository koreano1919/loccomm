package it.nero.loccomm.search.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("loccommSearch");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("loccommSearch");
        ...
        config.getMapConfigs().put("it.nero.loccomm.search.domain.*", initializeDomainMapConfig(jHipsterProperties));
