...
import it.nero.loccomm.domain.Product;
import it.nero.loccomm.repository.ProductRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
