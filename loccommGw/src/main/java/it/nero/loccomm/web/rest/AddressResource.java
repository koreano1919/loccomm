...
import it.nero.loccomm.domain.Address;
import it.nero.loccomm.repository.AddressRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
