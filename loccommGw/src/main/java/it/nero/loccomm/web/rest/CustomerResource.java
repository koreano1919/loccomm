...
import it.nero.loccomm.domain.Customer;
import it.nero.loccomm.repository.CustomerRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
