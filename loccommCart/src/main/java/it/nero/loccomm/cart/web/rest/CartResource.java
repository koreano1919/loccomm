...
import it.nero.loccomm.cart.repository.CartRepository;
...
/**
 * REST controller for managing {@link it.nero.loccomm.cart.domain.Cart}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CartResource {
    ...
    private static final String ENTITY_NAME = "loccommCartCart";
