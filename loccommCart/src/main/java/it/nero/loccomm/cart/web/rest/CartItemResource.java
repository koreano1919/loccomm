package it.nero.loccomm.cart.web.rest;

import it.nero.loccomm.cart.domain.CartItem;
import it.nero.loccomm.cart.repository.CartItemRepository;
import it.nero.loccomm.cart.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link it.nero.loccomm.cart.domain.CartItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CartItemResource {
    ...
    private static final String ENTITY_NAME = "loccommCartCartItem";
