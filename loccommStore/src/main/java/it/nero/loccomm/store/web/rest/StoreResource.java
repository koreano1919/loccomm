package it.nero.loccomm.store.web.rest;

import it.nero.loccomm.store.domain.Store;
import it.nero.loccomm.store.repository.StoreRepository;
import it.nero.loccomm.store.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link it.nero.loccomm.store.domain.Store}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class StoreResource {
    ...
    private static final String ENTITY_NAME = "loccommStoreStore";
