package it.nero.loccomm.shipment.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("loccommShipment");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("loccommShipment");
        ...
        config.getMapConfigs().put("it.nero.loccomm.shipment.domain.*", initializeDomainMapConfig(jHipsterProperties));
