...
@RestController
@RequestMapping("/api/loc-comm-kafka")
public class LocCommKafkaResource {
    private final Logger log = LoggerFactory.getLogger(LocCommKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public LocCommKafkaResource(KafkaProperties kafkaProperties) {
